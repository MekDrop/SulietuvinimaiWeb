function News(){
  ...
  str = new String();
	...
	if (rasta==0) document.write('</b></font></p><p>&nbsp; Jokių naujienų nėra.<font face="Georgia, Times New Roman, Times, serif"><b>'); else     document.write('</b></font></p><p>&nbsp; Šiuo metu yra ', rasta,' naujienų(-a).<br>&nbsp; Jeigu norite ką nors atsiųsti, tiesiog paspauskite ant to sulietuvinimo pavadinimo, kurį jūs norite atsisiųsti.<font face="Georgia, Times New Roman, Times, serif"><b>');
  for (i=LastPosition; i < MaxValue ; i++){
